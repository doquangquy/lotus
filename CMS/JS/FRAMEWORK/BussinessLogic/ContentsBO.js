...
var ContentsBO = {
    ...
    //#############################################################################
    // NgocBM
    Sel_ByKeyCodeContents_ByIDLang: function (KeyCodeContent, TitleLenght, IntroLenght) {
        var ret;
        jQuery.ajax({
            url: "/Action/ProcessBackendAction.ashx?ActionObject=Contents&action=Sel_ByKeyCodeContents_ByIDLang" + "&KeyCodeContent=" + KeyCodeContent + "&TitleLenght=" + TitleLenght + "&IntroLenght=" + IntroLenght + "&IDLang=" + sys_CUR_LANG,
            type: "POST",
            dataType: "json",
            data: "",
            success: function (data, dataStatus) {
