	...
	funescape = function (_, escaped) {
        ...
        */
        ...
        function Sizzle(selector, context, results, seed) {
            ...
            // QSA vars
		i, groups, old, nid, newContext, Contentselector;
            ...
            if (documentIsHTML && !seed) {
                ...
                if (support.qsa && (!rbuggyQSA || !rbuggyQSA.test(selector))) {
                    nid = old = expando;
                    newContext = context;
                    Contentselector = nodeType === 9 && selector;
                    ...
                    if (nodeType === 1 && context.nodeName.toLowerCase() !== "object") {
                        ...
                        Contentselector = groups.join(",");
                    }

                    if (Contentselector) {
                        try {
                            push.apply(results,
						newContext.querySelectorAll(Contentselector)
					);
                            return results;
                        } catch (qsaError) {
                        } finally {
