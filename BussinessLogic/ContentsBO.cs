...
namespace BussinessLogic
{
    public  class ContentsBO
    {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByIDLang(int IDLang) 
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).ToList();
            }
            catch (Exception ex)  
            {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByIDLang(int IDLang, bool Disable)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).Where(p => p.CategoryLevel1_Disable == Disable).ToList();
            }
            catch (Exception ex)
            {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCodeCategoryLevel1(string Code)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.CategoryLevel1_Code == Code).ToList();
            }
            catch (Exception ex)
            {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCodeCategoryLevel1(string Code, bool Disable)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.CategoryLevel1_Code == Code).Where(p=>p.Contents_CategoryLevel1_Disable == Disable).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("Sel_Ext_ByCodeCategoryLevel1:{0}", ex.Message));
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCodeCategoryLevel1_ByIDLang(string Code, int IDLang)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.CategoryLevel1_Code == Code).Where(b => b.Contents_CategoryLevel1_IDLang == IDLang).ToList();
            }
            catch (Exception ex)
            {
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCodeCategoryLevel1_ByIDLang(string Code, bool Disable, int IDLang)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.CategoryLevel1_Code == Code).Where(p => p.Contents_CategoryLevel1_Disable == Disable).Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("Sel_Ext_ByCodeCategoryLevel1_ByIDLang:{0}", ex.Message));
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCode(string Code)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.Contents_Code == Code).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("Sel_Ext_ByCodeCategoryLevel1:{0}", ex.Message));
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByCode(string Code, bool Disable)
        {
            try
            {
                return aDatabaseDA.vw_ContentsViewAll.Where(b => b.Contents_Code == Code).Where(p => p.Contents_Disable == Disable).ToList();
            }
            catch (Exception ex)
            {
                throw new Exception(String.Format("Sel_Ext_ByCodeCategoryLevel1:{0}", ex.Message));
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents_ByIDLang(string Key,  int IDLang)
        {
            try
            {
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p=>p.Contents_Code==Code).Where(p=>p.Contents_CategoryLevel1_IDLang == IDLang).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeCategoryLevel1_ByIDLang(string Key, int IDLang)
        {
            try
            {
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => p.CategoryLevel1_Code == Code).Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeCategoryLevel1_ByIDLang(string Key, int IDLang, bool Disable)
        {
            try
            {
                ConfigsBO aConfigsBO = new ConfigsBO();
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => p.CategoryLevel1_Code == Code).Where(p => p.Contents_CategoryLevel1_IDLang == IDLang).Where(p => p.Contents_Disable == Disable).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents(string Key)
        {
            try
            {
                ConfigsBO aConfigsBO = new ConfigsBO();
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => p.Contents_Code == Code).ToList();
        ...
        public List<vw_ContentsViewAll> Sel_Ext_ByKeyCodeContents(string Key, bool Disable)
        {
            try
            {
                ConfigsBO aConfigsBO = new ConfigsBO();
                ...
                return this.aDatabaseDA.vw_ContentsViewAll.Where(p => p.Contents_Code == Code).Where(p => p.Contents_Disable == Disable).ToList();
